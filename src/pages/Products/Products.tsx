...
export default function Products() {
	...
	const columns: ColumnsType<Product> = [
		...
		},
		{
			...
			ellipsis: true,
			sorter: (a, b) =>
				(a.description || '').localeCompare(b.description || ''), // string compare
		},
		{
			title: 'Category',
			...
			render: () => 'Pizza',
			sorter: (a, b) =>
				(a.categoryId || '').localeCompare(b.categoryId || ''), // until real name mapping exists
		},
		{
			title: 'Status',
		...
		},
		{
			...
			sorter: (a, b) =>
				...
				new Date(b.createdAt).getTime(), // date compare
