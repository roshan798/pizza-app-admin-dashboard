...
export default function CreateOrUpdateCategoryForm({
    ...
    const handleSubmit = (values: CategoryFormValues) => {
        ...
        const attributes: Category["attributes"] = values.attributes.map((attr) => ({
            ...attr,
    ...
    return (
        <Card>
            ...
            <Form
                ...
                initialValues={
                    initialCategory ? transformToFormValues(initialCategory) : { priceConfiguration: [], attributes: [] }
                }
            >
                {/* Category name */}
                <Form.Item
                        ...
                        <>
                            {fields.map(({ key, name, ...restField }) => (
                                ...
                                >
                                    ...
                                    >
                                        <Select placeholder="Price Type" style={{ width: 130 }}>
                                    ...
                                    <Form.Item
                                        ...
                                        rules={[{ required: true, message: "Enter options" }]}
                                    >
                            ...
                            {fields.map(({ key, name, ...restField }) => (
                                ...
                                >
                                    ...
                                    <Form.Item
                                        ...
                                        rules={[{ required: true, message: "Enter default value" }]}
                                    >
