...
import { fetchCategories as fetchCategoriesAPI, deleteCategory } from "../../http/Catalog/categories";
...
export default function CategoriesPage() {
            ...
            render: (_, record) => {
                const menu = (
                    <Menu>
                        ...
                        <Menu.Item key="edit">
                            <Link to={`/categories/edit/${record.id}`}>Edit</Link>
                        </Menu.Item>
                        <Menu.Item
                            key="delete"
                            danger
    ...
    return (
        <Card>
            ...
            {isError && <div style={{ color: "red" }}>Failed to load categories</div>}
        </Card>
    );
}
